                ...
                columns.push(
                    {
                        ...
                        onRender: (item: ISearchResult) => {
                            ...
                            renderColumnValue = <span title={!hasError ? value : ''} dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(value) }}></span>;
                            ...
                            if (column.isResultItemLink) {
                                ...
                                renderColumnValue = <a href={url} target='_blank' data-interception='off'>{renderColumnValue}</a>;
                            }

...
import { ISearchWebPartProps } from '../../webparts/search/ISearchWebPartProps';
...
export class TemplateService extends BaseTemplateService {
     ...
     */
    public getTemplateParameters(layout: ResultsLayoutOption, properties: ISearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void, availableProperties?: IComboBoxOption[]): IPropertyPaneField<any>[] {
    ...
    private _getDetailsListFields(properties: ISearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void): IPropertyPaneField<any>[] {
    ...
    private _getTileLayoutFields(properties: ISearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void): IPropertyPaneField<any>[] {
    ...
    private _getPeopleLayoutFields(properties: ISearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void): IPropertyPaneField<any>[] {
    ...
    private _ensureRequiredSelectedProperties(requiredProperties: string[], wpProperties: ISearchWebPartProps): void {

...
import { INbsSearchWebPartProps } from '../../webparts/nbsSearch/INbsSearchWebPartProps';
import { IPropertyPaneField, PropertyPaneToggle, PropertyPaneSlider } from '@microsoft/sp-webpart-base';
...
export class TemplateService extends BaseTemplateService {
     ...
     */
    public getTemplateParameters(layout: ResultsLayoutOption, properties: INbsSearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void, availableProperties?: IComboBoxOption[]): IPropertyPaneField<any>[] {
    ...
    private _getDetailsListFields(properties: INbsSearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void): IPropertyPaneField<any>[] {
        ...
        if (properties.templateParameters.enableFiltering === undefined || properties.templateParameters.enableFiltering === null) {
            properties.templateParameters.enableFiltering = false;
        }
    ...
    private _getTileLayoutFields(properties: INbsSearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void): IPropertyPaneField<any>[] {
        ...
        if (!properties.templateParameters.documentCardFields) {
            ...
            properties.templateParameters.documentCardFields = [
                ...
                { name: 'Location', field: 'location', value: `<a href="{{SPSiteUrl}}">{{SiteTitle}}</a>`, useHandlebarsExpr: true, supportHtml: true },
    ...
    private _getSliderLayoutFields(properties: INbsSearchWebPartProps): IPropertyPaneField<any>[] {
    ...
    private _getPeopleLayoutFields(properties: INbsSearchWebPartProps, onUpdateAvailableProperties?: (properties: IComboBoxOption[]) => void): IPropertyPaneField<any>[] {
        ...
        if (!properties.templateParameters.peopleFields) {
            ...
            properties.templateParameters.peopleFields = [
                ...
                { name: 'Tertiary Text', field: 'tertiaryText',  value: "{{#with (split AccountName '|')}}{{[0]}}{{/with}}", useHandlebarsExpr: true, supportHtml: false },
    ...
    private _ensureRequiredSelectedProperties(requiredProperties: string[], wpProperties: INbsSearchWebPartProps): void {

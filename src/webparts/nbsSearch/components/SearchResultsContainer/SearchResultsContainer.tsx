...
import SearchBoxContainer from './components/SearchBox/SearchBoxContainer/SearchBoxContainer';
import SearchRefinersContainer from './components/searchRefiners/SearchRefinersContainer/SearchRefinersContainer';
...
export default class SearchResultsContainer extends React.Component<ISearchResultsContainerProps, ISearchResultsContainerState> {
    ...
    public render(): React.ReactElement<ISearchResultsContainerProps> {
        ...
        let renderSearchrefinements: JSX.Element = null;
        ...
        if (this.props.useRefiners) {
            ...
            renderSearchrefinements= <SearchRefinersContainer
                ...
                refinersSelectedLayout={this.props.refinersSelectedLayout}
                language={this.props.language}
                defaultSelectedRefinementFilters = {this.props.defaultSelectedRefinementFilters}
    ...
    private _onRefinementUpdate(appliedRefiners: IRefinementFilter[]) {
        ...
        this.props.onRefinersUpdate (true, appliedRefiners);  
    }
    /**
   ...
   */
    ...
    public async componentDidMount() {
        ...
        if (this.state.searchQuery) {
            try {
                ...
                const updatedAvailableRefinements = searchResults.RefinementResults.length > 0 ? searchResults.RefinementResults : this.state.availableRefiners;
                this.setState({
                    results: searchResults,
                    availableRefiners: updatedAvailableRefinements,
                    areResultsLoading: false
                });
    ...
    */
    ...
    private async _getSearchResults(props: ISearchResultsContainerProps, pageNumber?: number): Promise<ISearchResults> {
        ...
        // Get search results
        const searchResults = await props.searchService.search(this.state.searchQuery, pageNumber, this.props.templateService.UseOldSPIcons);

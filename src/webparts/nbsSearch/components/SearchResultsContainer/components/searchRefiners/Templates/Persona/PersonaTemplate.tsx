...
export default class PersonaTemplate extends React.Component<IPersonaTemplateProps, IPersonaTemplateState> {
      ...
      <div className={styles.pnpRefinersTemplatePersona}>
        {
            this.props.showValueFilter ?
                <div className="pnp-value-filter-container">
                    <TextField value={this.state.valueFilter} placeholder="Filter" onChanged={(newValue?: string) => { this._onValueFilterChanged(newValue); }} onClick={this._onValueFilterClick} />
  ...
  public componentWillReceiveProps(nextProps: IPersonaTemplateProps) {
     ...
     */
    this.setState({
      refinerSelectedFilterValues: nextProps.selectedValues
    });
